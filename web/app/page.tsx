    ...
    <main className="mx-auto max-w-7xl px-4 pb-16 pt-8 sm:px-6">
      <MotionReveal>
        <section className="relative overflow-hidden rounded-[2rem] border border-white/50 bg-card/80 shadow-2xl shadow-black/10">
          <div className="pointer-events-none absolute inset-x-0 top-0 h-40 bg-linear-to-b from-secondary/30 via-secondary/10 to-transparent" />
          ...
          <div className="relative grid gap-8 p-6 sm:p-8 md:gap-10 md:p-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(340px,0.95fr)] lg:items-center">
            ...
            <MotionReveal delay={0.18} y={18}>
              <div className="relative mx-auto w-full max-w-xl">
                <div className="absolute inset-0 rounded-[2rem] bg-linear-to-br from-secondary/40 via-white/10 to-primary/20 blur-2xl" />
                <div className="relative overflow-hidden rounded-[2rem] border border-white/60 bg-stone-950 p-3 shadow-[0_24px_80px_rgba(28,25,23,0.24)]">
                  ...
                  <div className="relative aspect-4/5 overflow-hidden rounded-4xl">
                    ...
                    />
                    <div className="absolute inset-0 bg-linear-to-t from-stone-950/70 via-stone-950/5 to-white/10" />
