...
import { grantEnterpriseAccess } from "@/lib/api/subscribers";
...
export async function POST(
  ...
  // Pass actor id so the database audit log records who granted access.
  const updated = await grantEnterpriseAccess(trimmedUserId, parseReason(body), user.id);
